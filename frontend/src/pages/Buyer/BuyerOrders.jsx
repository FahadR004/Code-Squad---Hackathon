                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-gray-600">
                      Contact: {order.farmerId.phone_no}
                    </p>
                  </div>
                    ...
                    {order.items.map((item, index) => (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {item.quantity} × PKR {item.price.amount}/{item.price.unit}
                          </p>
                        </div>
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    {order.isReviewed && (
                      <span className="bg-green-100 text-green-700 px-4 py-2 rounded flex items-center gap-2">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl w-96 max-w-full mx-4">
            <h3 className="text-xl font-semibold mb-4">
              Rate Farmer: {selectedOrder.farmerId.name}
            </h3>
            ...
            <textarea
              ...
              className="border w-full p-3 rounded-lg mb-4 focus:outline-none focus:ring-2 focus:ring-green-500"
              rows="4"
            />
