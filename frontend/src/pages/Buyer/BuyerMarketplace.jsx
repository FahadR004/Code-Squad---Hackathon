...
export default function BuyerMarketplace() {
  ...
  useEffect(() => {
    const sampleProducts = [
      { id: 1, name: "Fresh Tomatoes", category: "Vegetables", price: 250, qty: 120, image: "https://images.unsplash.com/photo-1567306226416-28f0efdc88ce" },
      { id: 2, name: "Organic Potatoes", category: "Vegetables", price: 180, qty: 200, image: "https://images.unsplash.com/photo-1603052875633-48f5fdf3f8a6" },
      { id: 3, name: "Bananas", category: "Fruits", price: 220, qty: 130, image: "https://images.unsplash.com/photo-1574226516831-e1dff420e12e" },
      { id: 4, name: "Wheat Grain", category: "Grains", price: 150, qty: 500, image: "https://images.unsplash.com/photo-1603046891744-6191f1c5d4e2" },
      { id: 5, name: "Fresh Milk", category: "Dairy Products", price: 180, qty: 60, image: "https://images.unsplash.com/photo-1582719478173-e6cf49176c39" },
      { id: 6, name: "Pure Honey", category: "Other", price: 1200, qty: 50, image: "https://images.unsplash.com/photo-1601004890684-d8cbf643f5f2" },
    ]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-green-700 text-white px-6 py-4 flex justify-between items-center shadow-md relative">
        <h1 className="text-2xl font-bold">🛒 Buyer's Marketplace</h1>
          ...
          <div className="relative">
            ...
            {showFilters && (
              <div className="absolute mt-2 bg-white text-black border rounded shadow-lg w-56 right-0 z-50">
                {["All", "Fruits", "Vegetables", "Grains", "Dairy Products", "Other"].map((cat) => (
                  <button
                    key={cat}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProducts.map((p) => (
              <div key={p.id} className="bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
                ...
                <p className="text-sm text-gray-600">Price: PKR {p.price}</p>
                <p className="text-sm text-gray-600">Available: {p.qty}</p>
      ...
      {selected && (
        <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded shadow w-80">
            <h3 className="font-semibold mb-2 text-lg">Order: {selected.name}</h3>
            <input
              type="number"
              min="1"
              value={quantity}
