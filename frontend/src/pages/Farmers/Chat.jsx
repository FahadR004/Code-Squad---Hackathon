...
//         <div className="w-full max-w-lg h-4/5 flex flex-col bg-white bg-opacity-90 rounded-lg shadow-lg overflow-hidden md:max-w-2xl">
//           {/* Navbar */}
//           <nav className="flex justify-between items-center p-4 bg-green-500 text-white md:flex-row">
//             <h2 className="text-lg font-bold">Farmer-Buyer Chat</h2>
//             <div className="flex space-x-2">
//               <button className="px-3 py-1 border border-white text-white hover:bg-white hover:text-green-500 rounded transition">Settings</button>
//               <button className="px-3 py-1 border border-white text-white hover:bg-white hover:text-green-500 rounded transition">Logout</button>
//             </div>
//           </nav>

//           {/* Chat Window */}
//           <div ref={chatWindowRef} className="flex-1 p-4 overflow-y-auto bg-gray-50 relative">
//             {messages.map((msg) => (
//               <div
//                 key={msg.id}
//                 className={`mb-3 p-3 rounded-lg max-w-3/4 transition hover:shadow-md animate-fade-in cursor-pointer relative ${
//                   msg.user === 'Farmer'
...
//                     />
//                     <button onClick={saveEdit} className="mt-1 px-2 py-1 bg-green-500 text-white rounded">Save</button>
//                   </div>
//                 ) : (
//                   <>
...
//           {/* Typing Indicator */}
//           {isTyping && (
//             <div className="p-3 italic text-gray-500 animate-pulse">
//               {currentUser === 'Farmer' ? 'Buyer' : 'Farmer'} is typing...
//             </div>
//           )}

//           {/* Input Area */}
//           <div className="flex p-3 bg-white border-t border-gray-300 md:flex-row">
//             <select
//               value={currentUser}
//               onChange={(e) => setCurrentUser(e.target.value)}
//               className="mr-3 p-2 border border-gray-300 rounded hover:border-green-500 focus:border-green-500 transition md:mr-3"
//             >
...
//               className="flex-1 p-2 border border-gray-300 rounded hover:border-green-500 focus:border-green-500 transition mr-3 md:mr-3"
//             />
//             <button
//               onClick={sendMessage}
...
//       {/* Right Side: Just Background Image */}
//       <div
//         className="flex-1"
//         style={{
//           backgroundImage: "url('https://plus.unsplash.com/premium_photo-1663076535013-5058cb29d3c9?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=870')",
